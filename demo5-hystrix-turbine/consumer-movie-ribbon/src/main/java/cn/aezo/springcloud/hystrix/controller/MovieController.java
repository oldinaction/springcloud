package cn.aezo.springcloud.hystrix.controller;

import cn.aezo.springcloud.hystrix.entity.User;
import cn.aezo.springcloud.hystrix.feign.UserFeignClient;
import cn.aezo.springcloud.hystrix.services.UserService;
